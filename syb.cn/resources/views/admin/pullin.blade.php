    ...
    <div class="container changepasswordtop">
        <div class="panel panel-info">
            ...
            <div class="well well-sm center-block" style="width: 80%;">
                ...
                <br>
               <div class="row">
                   <a href="{{url('/js/question_bank_model.txt')}}" download class="btn btn-success col-md-offset-3" role="button">下载题目模板</a>
...
//            console.log(question_bank_path)
            $.post('pullin',{'_token':"{{csrf_token()}}",'question_bank':question_bank_path},function (res) {
                console.log(res)
            })
        })
