        ...
        <div class="panel panel-info">
            ...
            <div class="panel-body">
                @if(isset($res) && $res != '' && $res!=null)
                    <b >
                       最近于 <mark> {{$res->add_time}} </mark> 组卷，<a href="{{url('admin/view_paper/'.$paper_id->id)}}" target="main">点击此处</a> 查看组卷详情！
                    </b>
                @else
                    <b class="text-danger">
            ...
            <div class="well question-box">
                <form class="form-horizontal" method="post" action="" >
                    ...
                    <div class="form-group ">
                        <label class="col-md-2 col-md-offset-3 control-label">题库中有单选题 <mark>{{$num_4}}</mark> 道</label>
                        <label class="col-md-2 control-label">判断题 <mark>{{$num_2}}</mark> 道</label>
                    </div>
                    <br>
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div id="range">
                                ...
                                {{--<span class="score4">单选题总分： <mark></mark> 分</span>--}}
                            </div>
                        </div>
                    </div>
                    {{--<div class="form-group">--}}
                        {{--<label class="col-md-2 control-label">多选题个数：</label>--}}
                        {{--<div class="col-md-8">--}}
                            {{--<div id="range">--}}
                                {{--<input name="type44" type="range" min="0" max="30" step="1" value="0" class="form-control">--}}
                                {{--<span class="value44">0 道</span>--}}
                                {{--<span class="score col-md-5">--}}
                                    {{--<input type="number" name="score44" class="form-control col-md-1" placeholder="几分 / 题">--}}
                                {{--</span>--}}
                                {{--<span class="score44">单选题总分： <mark></mark> 分</span>--}}
                            {{--</div>--}}
                        {{--</div>--}}
                    {{--</div>--}}
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <div id="range">
                               ...
                               <span class="value2">0 道</span>
                                ...
                                {{--<span class="score2">单选题总分： <mark></mark> 分</span>--}}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        {{--<div class="col-md-2" >--}}
                        {{--<input type="number" name="score2" class="form-control col-md-1"  placeholder="小时">--}}
                        {{--</div>--}}
