...
<body style="background-color: #eee">
    <div class="container">
       <div class="logo-text center-block">
           <img class="img-responsive img-thumbnail" src="<?php echo e(url('/imgs/logo-ilo.jpg')); ?>" alt="logo" id="admin-logo" /> <br />
           ...
           <form action="" class="form-horizontal" method="post">
               ...
               <?php if(session('msg')): ?>
                  <div class="center-block">
                      <span class="alert alert-danger text-center col-md-9 col-md-pull-2" role="alert"><?php echo e(session('msg')); ?></span> <br /><br />
                  </div>
               <?php endif; ?>
               ...
               <div class="form-group" id="code-box">
                   ...
                   <img class="img-rounded" id="code" src="<?php echo e(url('code')); ?>" alt="验证码" title="点击可更换" onclick="this.src='<?php echo e(url('code')); ?>?'+Math.random()">​​​​
               </div>
                <div class="form-group">
