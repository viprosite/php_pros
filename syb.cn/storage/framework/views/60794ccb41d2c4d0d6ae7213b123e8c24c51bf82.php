            ...
            <form class="form-horizontal" action="" method="post">
               ...
               <div class="form-group">
                   <div class="col-md-10 col-md-offset-5">
                       <a href="<?php echo e(url('register')); ?>" class="regToLogin"> <i class="fa fa-lg fa-hand-o-right" style="color: #666;"></i> 还没注册？点击我</a>
                       <br><br>
                           <mark><b><a href="<?php echo e(url('admin')); ?>" class=""> <i class="fa fa-lg fa-desktop" style="color: #666;padding-left: 5%"></i> 管理员登陆</a></b></mark>
                   </div>
               </div>
            </form>
        </div>
